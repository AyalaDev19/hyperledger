...
import (
	...
	"github.com/AyalaDev19/hyperledger/chaincode-go-1/chaincode"

	"github.com/AyalaDev19/hyperledger/chaincode-go-1/chaincode/mocks"
...
func TestCreateAsset(t *testing.T) {
	...
	assetTransfer := chaincode.SmartContract{}
	err := assetTransfer.CreateAsset(transactionContext, "", 0, "", "", "", "", "", "", "", 0, 0.0)
	require.NoError(t, err)

	chaincodeStub.GetStateReturns([]byte{}, nil)
	err = assetTransfer.CreateAsset(transactionContext, "asset1", 0, "", "", "", "", "", "", "", 0, 0.0)
...
func TestUpdateAsset(t *testing.T) {
	...
	chaincodeStub.GetStateReturns(bytes, nil)
	assetTransfer := chaincode.SmartContract{}
	err = assetTransfer.UpdateAsset(transactionContext, "", 0, "", "", "", "", "", "", "", 0, 0.0)
	require.NoError(t, err)

	chaincodeStub.GetStateReturns(nil, nil)
	err = assetTransfer.UpdateAsset(transactionContext, "asset1", 0, "", "", "", "", "", "", "", 0, 0.0)
	require.EqualError(t, err, "the asset asset1 does not exist")
